...
// StudentID: 925573
// Class: COMP30019 Graphics and Interaction, 2020 Semester 2
// Description: A shader that uses displacement of vertices with Gerstner Waves
//              to create a realistic looking water surface. Project where the
//              shader was used can be found at: https://youtu.be/XBnPUesIWIY
...
Shader "Custom/Waves 1.3"
{
    ...
    SubShader
    {
        ...
        // I implemented the method found here: htps://catlikecoding.com/unity/tutorials/flow/waves/
        float3 GerstnerWave (
